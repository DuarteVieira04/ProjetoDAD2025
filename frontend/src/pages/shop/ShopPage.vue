        ...
        <Card>
            ...
            <CardContent>
                <div class="space-y-4">
                    <label class="block">
                        Payment Type
                        <select v-model="payment.type" class="w-full border p-2 rounded">
                    ...
                    <label class="block">
                        Reference
                        <input v-model="payment.reference" type="text" class="w-full border p-2 rounded"
                            placeholder="Enter payment reference" />
                    </label>

                    <label class="block">
                        Amount (€)
                        <input v-model.number="payment.value" type="number" min="1" max="99"
...
const submitPurchase = async () => {
    ...
    try {
        ...
        success.value = `Purchase successful! You received ${payment.value * 10} coins.`
    } catch (err) {
